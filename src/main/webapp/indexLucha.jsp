...
<body>
	...
	<form action="${destino }" method="${metodo }">
	 <input type="hidden" class="form-control" id="luchador1" name="luchador1" aria-describedby="emailHelp" value="${ luchador1}">
		<table class="table">
					...
					<tr>
						<th scope="col">
							<div class="form-check">
  								<input class="form-check-input" type="radio" name="luchador" value="${caballero.id }">
  							</div>	
  						</th>
